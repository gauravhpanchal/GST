...
@NgModule({
  declarations: [
    IndividualComponent,
    GSTComponent,
    LeadsForStateSectionComponent,
    OrganisationInfoComponent,
    IndividualInfoComponent,
    BankDetailsComponent,
    PPOBComponent,
    APOBComponent,
    ComplainceCheckComponent,
    InvoiceComponent,
    CreateGSTAppComponent,
    IndividualInfoItemComponent,
    TaxInvoiceForOtherComponent,
    TaxInvoiceForCAComponent,
    AppApobItemComponent,
    GstListComponent,
  ],
  imports: [
    CommonModule,
